...
Usage:
    ...
    uv run python scan_claude_skills.py --use-behavioral

    # Scan with all analyzers (requires SKILL_SCANNER_LLM_API_KEY env var)
    uv run python scan_claude_skills.py --use-behavioral --use-llm

    # Generate detailed markdown report
    uv run python scan_claude_skills.py --format markdown --output report.md

    # CI/CD mode - fail if critical/high findings
    uv run python scan_claude_skills.py --fail-on-findings
"""
